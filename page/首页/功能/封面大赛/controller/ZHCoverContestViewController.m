//
//  ZHCoverContestViewController.m
//  exhibition
//
...
@interface ZHCoverContestViewController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetDelegate,DZNEmptyDataSetSource>
...
@implementation ZHCoverContestViewController
...
- (void)viewDidLoad {
    ...
    [self customNavigationItem:position_right title:@"往期回顾" backgroundImage:ImageName(@"") action:@selector(ClickBeforeContest)];
...
#pragma mark 往期回顾
- (void)ClickBeforeContest{
    ZHLookContestViewController *lookVC = [ZHLookContestViewController new];
